...
class Device(Serializable):
    ...
    def __init__(self, device_name: str, id: str, managed_by_user_id: str, end_of_life: datetime = None, creation_date: datetime = None, last_update: datetime = None):
    ...
    def instantiate_from_dict(cls, data: dict) -> Self:
        return cls(data.get('device_name'), data['id'], data['managed_by_user_id'], data['end_of_life'], data['creation_date'], data['last_update'])
...
if __name__ == "__main__":
    # Create a device
    device1 = Device("Device1", "Name1", "one@mci.edu")
    device2 = Device("Device2", "Name2", "two@mci.edu") 
    device3 = Device("Device3", "Name3", "two@mci.edu") 
    device1.store_data()
    device2.store_data()
    device3.store_data()
    device4 = Device("Device3", "Name4", "four@mci.edu") 
    device4.store_data()
